 ...
 *   document on the DataTables site
 ...
 *   `button-selector` document on the DataTables site
...
/**
 * Buttons defaults. For full document, please refer to the docs/option
 ...
 * DataTables API
 *
 * For complete document, please refer to the docs/api directory or the
 * DataTables site
 */
